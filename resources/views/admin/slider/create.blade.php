        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <form action="{{ url('admin/slider', []) }}" class="forms-sample" enctype="multipart/form-data" method="POST">
                  @csrf
                  ...
                  <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" name="description" id="meta_keyword"  ></textarea> @error('meta_keyword')
                    <small class="text-danger">{{$message}}</small>
                @enderror
                  </div>  
                  <div class="form-group">
